...
HD_PWD='Z:/Documents/DEV/projektmanagement-ss-2017/LBP HDL Port/zedboard/lbp_standalone/lbp_standalone.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lbp_standalone.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lbp_standalone.tcl
