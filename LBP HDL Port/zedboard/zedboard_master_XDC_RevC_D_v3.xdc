...
#create_clock -period 100.000 -name CLK -waveform {0.000 50.000} [get_ports GCLK]
#create_clock -period 10.00 -name GCLK -waveform {0.000 5.000} [get_ports GCLK]
...
#set_property PACKAGE_PIN AB11 [get_ports SD_DAT1];  # "JA7"
#set_property PACKAGE_PIN AB10 [get_ports SD_DAT2];  # "JA8"
...
#set_property PACKAGE_PIN T6  [get_ports {JC[4]}];  # "JC3_N"
#set_property PACKAGE_PIN R6  [get_ports {JC[7]}];  # "JC3_P"
#set_property PACKAGE_PIN U4  [get_ports {JC[8]}];  # "JC4_N"
#set_property PACKAGE_PIN T4  [get_ports {JC[9]}];  # "JC4_P"
...
#set_property PACKAGE_PIN D11  [get_ports {uart_read}];
#set_property PACKAGE_PIN C14  [get_ports {uart_write}];